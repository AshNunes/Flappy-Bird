...
// var dinheiro_ganho = 0;


var dinheiroElemento;
var dinheiroAtual;
var novoDinheiro;
...
// function obterValorApostado() {
//     // Obtém o valor digitado no input com o id "dinheiro"
//     var valorApostado = document.getElementById("dinheiro").value;

//     // Faça algo com o valor, por exemplo, exiba-o no console
//     console.log("Valor Apostado: R$" + valorApostado);
// }
...
function atualizar() {
    ...
    for (let i = 0; i < arrayCanos.length; i++) {
        ...
        if (!cano.passou && passaro.x > cano.x + cano.largura) {
            ...
            if (valorApostado <= 0) {
                console.log("sem dinheiro apostado");
            }
            else {
                
                if (valorApostado >= 1 && valorApostado < 50) {
                    velocidadeX = -2;
                    velocidadeY = 0;
                    posicaoXCano = larguraTabuleiro;
                }
                else if (valorApostado >= 50 && valorApostado < 100) {
                    velocidadeX = -3;
                    velocidadeY = -2.5;
                }
                else if (valorApostado >= 100 && valorApostado <= 149) {
                    velocidadeX = -5;
                    velocidadeY = -3.5;
                    posicaoXCano = 200;
                } 
                else if (valorApostado >= 150) {
                    velocidadeX = -7;
                    velocidadeY = 3.5;
                    posicaoXCano = 180;
                }
                ...
                if (pontuacao <= 10) {
                    dinheiroElemento = document.getElementById("rs");
                    dinheiroAtual = parseFloat(dinheiroElemento.textContent);
                    novoDinheiro = dinheiroAtual + 0.5;
                    dinheiroElemento.textContent = novoDinheiro;
                }
                else if (pontuacao > 10 && pontuacao <= 50) {
                    dinheiroElemento = document.getElementById("rs");
                    dinheiroAtual = parseFloat(dinheiroElemento.textContent);
                    novoDinheiro = dinheiroAtual + 1.5;
                    dinheiroElemento.textContent = novoDinheiro;
                }
                else if (pontuacao > 50 && pontuacao <= 80) {
                    dinheiroElemento = document.getElementById("rs");
                    dinheiroAtual = parseFloat(dinheiroElemento.textContent);
                    novoDinheiro = dinheiroAtual + 2.5;
                    dinheiroElemento.textContent = novoDinheiro;
                }
                else if (pontuacao > 80 && pontuacao <= 100) {
                    dinheiroElemento = document.getElementById("rs");
                    dinheiroAtual = parseFloat(dinheiroElemento.textContent);
                    novoDinheiro = dinheiroAtual + 3.5;
                    dinheiroElemento.textContent = novoDinheiro;
                }
                else if (pontuacao > 100) {
                    dinheiroElemento = document.getElementById("rs");
                    dinheiroAtual = parseFloat(dinheiroElemento.textContent);
                    novoDinheiro = dinheiroAtual * 2;
                    dinheiroElemento.textContent = novoDinheiro;
                }
